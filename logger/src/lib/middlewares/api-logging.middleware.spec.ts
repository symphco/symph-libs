Here's a cleaner and more concise version of the unit test file content after incorporating the changes from the business logic file:
...
This version follows clean code principles, breaking down tests into smaller and more focused units. The use of `beforeEach` ensures setup code is minimal, making the tests themselves easier to understand. Unnecessary repetition and clutter have been removed to improve readability.